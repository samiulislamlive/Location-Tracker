...
class _MyHomePageState extends State<MyHomePage> {
  ...
  getMarkerPos(LatLng position) async{
    ...
    String subadmin = placemark.subAdministrativeArea ?? '';
    String street = placemark.street ?? '';
    _showLocationInfoDialog(city, country,sub,admin,subadmin,street, position.latitude, position.longitude, position);
  }
                  ...
                  Column(
                    children: [
                      MaterialButton(onPressed: () async{
                        ...
                        Navigator.pop(context);
                      }, child: Icon(Icons.local_mall),padding: EdgeInsets.all(16),
                        shape: CircleBorder(),
                        color: Colors.white,),
                      Text("Mall",
                        style: TextStyle(
  ...
  void _showLocationInfoDialog(String city,String country,String sub,String admin,String subadmin,String street, double lat, double long, LatLng position) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
